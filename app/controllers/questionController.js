...
const questionsController = {
    ...
    async getQuestionByIdAnswers(req, res, next) {
        ...
        /*Call the function findByPkAllAnswers with question id
          ...
          pseudo.answer (who have wrote the answer), answer_id, answer content,
    ...
    async haveIvoted(req,res,next) {
       ...
       /*Call the function haveIvoted with the user id and
    ...
    async deleteAnswerAndVote(req, res, next) {
      ...
      /*retrieve question id and answer id*/
      const {questionId, answerId} = req.params;

      /*Call the function deleteAnswerVote with the answer id and
        question id for unvoted the answer*/
